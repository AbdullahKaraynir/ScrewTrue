...
export default function App() {
  ...
  const detectObjects = async (base64Image) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setImageSize(data.image_size || { width: 0, height: 0 });
      } else {
        setDetections([]);
      ...
      <View style={styles.camContainer}>
        <CameraView ref={cameraRef} style={styles.camera} facing="back">
          ...
          <Animated.View style={[styles.scanLine, { transform: [{ translateY: scanTranslateY }] }]}>
            <LinearGradient
              colors={['transparent', 'rgba(74, 85, 104, 0.6)', 'transparent']}
              start={{ x: 0, y: 0 }}
              end={{ x: 1, y: 0 }}
        ...
        >
          ...
          <TouchableOpacity style={styles.captureBtn} onPress={takePicture} disabled={isLoading}>
            <View style={styles.captureBtnOuter}>
              {isLoading ? (
                <ActivityIndicator color="#4A5568" size="large" />
              ) : (
  ...
  return (
    <SafeAreaView style={styles.container}>
      <StatusBar barStyle="light-content" />
      <LinearGradient colors={['#2C3E50', '#34495E', '#4A5568']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={styles.header}>
        <Text style={styles.headerText}>ScrewTrue</Text>
      </LinearGradient>
...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: '#2C3E50', paddingVertical: scale(14), paddingHorizontal: scale(20), alignItems: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.15, shadowRadius: 4, elevation: 5 },
  headerText: { color: '#fff', fontSize: scale(22), fontWeight: '700', letterSpacing: 1 },
  scrollView: { flex: 1 },
  home: { padding: scale(16), paddingTop: scale(8), paddingBottom: scale(20), alignItems: 'center' },
  logoImage: { width: scale(120), height: scale(120), marginTop: scale(4), marginBottom: scale(6) },
  subtitle: { fontSize: scale(16), color: '#4A5568', marginBottom: scale(12), fontWeight: '500', letterSpacing: 0.5 },
  infoCard: { backgroundColor: '#fff', borderRadius: scale(16), padding: scale(16), width: '100%', marginBottom: scale(12), shadowColor: '#2C3E50', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 8, elevation: 4 },
  infoTitle: { fontSize: scale(16), fontWeight: '700', textAlign: 'center', marginBottom: scale(12), color: '#2C3E50' },
  classGrid: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center' },
  classItem: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#F7F9FC', padding: scale(10), borderRadius: scale(20), margin: scale(4), shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.06, shadowRadius: 2, elevation: 1 },
  classEmoji: { fontSize: scale(20), marginRight: scale(6) },
  classText: { fontSize: scale(13), color: '#4A5568', fontWeight: '600' },
  primaryBtn: { backgroundColor: '#4A5568', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: scale(14), paddingHorizontal: scale(24), borderRadius: scale(14), width: '100%', marginBottom: scale(10), shadowColor: '#2C3E50', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.25, shadowRadius: 6, elevation: 4 },
  primaryBtnText: { color: '#fff', fontSize: scale(17), fontWeight: '700', letterSpacing: 0.5 },
  secondaryBtn: { backgroundColor: '#fff', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: scale(14), paddingHorizontal: scale(24), borderRadius: scale(14), width: '100%', borderWidth: 2, borderColor: '#4A5568', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.08, shadowRadius: 4, elevation: 2 },
  secondaryBtnText: { color: '#4A5568', fontSize: scale(17), fontWeight: '700', letterSpacing: 0.5 },
  btn: { backgroundColor: '#4A5568', paddingVertical: scale(16), paddingHorizontal: scale(32), borderRadius: scale(12), marginTop: scale(20), shadowColor: '#2C3E50', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.25, shadowRadius: 6, elevation: 4 },
  btnText: { color: '#fff', fontSize: scale(16), fontWeight: '700' },
  permText: { fontSize: scale(17), color: '#4A5568', marginBottom: scale(12), fontWeight: '500' },
  // Camera Styles
  ...
  statusScanning: { backgroundColor: 'rgba(74, 85, 104, 0.95)' },
  ...
  captureBtnCore: { width: 60, height: 60, borderRadius: 30, backgroundColor: '#fff', borderWidth: 3, borderColor: '#4A5568' },
  ...
  resultContainerFull: { flex: 1, backgroundColor: '#F5F7FA' },
  ...
  summarySubSmall: { fontSize: scale(12), color: '#4A5568', fontWeight: '600' },
  ...
  newBtnCompact: { borderRadius: scale(14), overflow: 'hidden', shadowColor: '#2C3E50', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.25, shadowRadius: 6, elevation: 4 },
  ...
  loadingText: { marginTop: scale(18), fontSize: scale(19), color: '#4A5568', fontWeight: '700' },
});
