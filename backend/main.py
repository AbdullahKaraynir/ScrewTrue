"""
ScrewTrue - Object Detection API (ONNX Version)
FastAPI backend for screw head type classification using ONNX Runtime
"""
...
app = FastAPI(
    title="ScrewTrue API (ONNX)",
    description="Vida basligi tanima icin nesne tespit API'si - ONNX Runtime",
    version="2.0.0",
)
...
# ONNX Model yolu
# backend/main.py -> Data_Mining_Project -> screwtrue_model (model klasörü)
ROOT_DIR = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
MODEL_PATH = os.path.join(ROOT_DIR, "screwtrue_model", "run", "weights", "best.onnx")
...
async def root():
    ...
    return {
        "status": "active",
        "message": "ScrewTrue ONNX API calisiyor",
        "version": "2.0.0",
